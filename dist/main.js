...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n\nconst ipGeoApi = (() => {\n  const apiHost = 'https://extreme-ip-lookup.com/json/';\n\n  const getUsersCity = () => {\n\n    return fetch(apiHost).then( response => {\n      return response.json();\n    });\n  }\n\n  return { getUsersCity };\n\n})();\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (ipGeoApi);\n\n//# sourceURL=webpack:///./src/plugins/ipGeoApi.js?");
